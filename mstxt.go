package main 
// this is generated by go_build_multi_exec from (forked_makeself/makeself.sh) do not manually edit
// see -help for more details

// Mstxt is the exported text of an internal part of the shell archive subsystem
var Mstxt = `#!/bin/sh
#
