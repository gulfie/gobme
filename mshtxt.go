package main 
// this is generated by go_build_multi_exec from (forked_makeself/makeself-header.sh) do not manually edit
// see -help for more details

// Mshtxt is the exported text of an internal part of the shell archive subsystem
var Mshtxt = `cat << EOF  > "$archname"
#!/bin/sh
