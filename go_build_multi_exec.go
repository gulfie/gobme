...
var lookforbackticks = regexp.MustCompile("`")

	//  srcfilename, destfilename (.go file), variablename 
var relativefn = [][3]string{
...
func srcfileToGofiletxt( payload , srcfn , varname  string ) (strtxt string ) {

		escaped := lookforbackticks.ReplaceAllString(payload,"` + \"`\" + `")
